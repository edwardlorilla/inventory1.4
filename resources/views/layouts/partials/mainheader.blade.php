                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <!-- User Image -->
                                            <img src="{{Auth::user()->photo ? Auth::user()->photo->file : 'http://lorempixel.com/50/50'}}" class="img-circle" alt="User Image"/>
                                        </div>
                ...
                @else
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{Auth::user()->photo ? Auth::user()->photo->file : 'http://lorempixel.com/50/50'}}" class="user-image" alt="User Image">
